...
class SystemMailTemplateSeeder extends Seeder
{
    public function run(): void
    {
        $templates = [
            ...
            [
                'slug' => 'mensaje_chat',
                'name' => 'Mensaje de Chat de Pedido',
            ...
            [
                'slug' => 'welcome_proveedor',
                'name' => 'Bienvenida Proveedor',
        ...
        $this->command->info('Plantillas de sistema creadas: '.count($templates));
    }
}
