    ...
    @component('livewire.dashboard.base-widget', [
        ...
        <div class="flex items-center justify-between mt-2">
            <div class="text-3xl font-black text-emerald-600 dark:text-emerald-400">
                {{ \App\Helpers\MoneyHelper::formatWithSymbol($ventasPeriodo) }}
            </div>
        ...
        <div class="mt-4 flex justify-end">
            <a href="{{ route('ventas.index') }}" class="text-xs text-zinc-500 hover:text-zinc-700 dark:text-zinc-400 dark:hover:text-zinc-200 flex items-center gap-1 font-semibold">
                Ver Ventas
